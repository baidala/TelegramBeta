            ...
            public void onItemClick(int id) {
                if (id == -1) {
                    ...
                    if (wallPaper != null && wallPaper.id != 1000001 && wallPaper instanceof TLRPC.TL_wallPaper) {
                        ...
                        File toFile;
                        if(dialog_id != 0) {
                            toFile = new File(ApplicationLoader.getFilesDirFixed(), "wallpaper" + dialog_id + ".jpg");
                        } else {
                    ...
                    if (done) {
                        ...
                        if(dialog_id != 0) {
                            preferences = ApplicationLoader.applicationContext.getSharedPreferences("dialog_config_" + dialog_id, Activity.MODE_PRIVATE);
                        } else {
                        ...
                        editor.commit();
                        if(dialog_id != 0){
                            Theme.reloadWallpaper(dialog_id);
                        } else {
